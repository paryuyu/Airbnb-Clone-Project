...
export const StaticMap: React.FC= () => {
    ...
    function createStaticMap() {
        ...
        return `https://maps.googleapis.com/maps/api/staticmap?center=${ctx.what.lat},${ctx.what.lng}&zoom=18&size=300x300&markers=size:mid%7Ccolor:green%7Clabel:S%7C${ctx.what.lat},${ctx.what.lng}&key=AIzaSyAXTs6QeXQ0EZ4B5pCOv93vnnCx0LwEKIs`;
